...
# Connect via gateway - Updated with current instance details
# Direct: ssh -p 28259 root@24.124.32.70
# Proxy: ssh -p 24285 root@ssh4.vast.ai
ssh -p 24285 root@ssh4.vast.ai -L 5678:localhost:5678 -L 8501:localhost:8501 -L 8001:localhost:8001 -L 8002:localhost:8002 -L 8003:localhost:8003 -L 8004:localhost:8004 -L 11434:localhost:11434
